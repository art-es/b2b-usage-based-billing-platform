...
func (c *orgnServiceClient) GetById(ctx context.Context, in *GetByIdRequest, opts ...grpc.CallOption) (*Orgn, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Orgn)
	err := c.cc.Invoke(ctx, OrgnService_GetById_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedOrgnServiceServer must be embedded to have
...
// UnsafeOrgnServiceServer may be embedded to opt out of forward compatibility for this service.
// Use of this interface is not recommended, as added methods to OrgnServiceServer will
// result in compilation errors.
type UnsafeOrgnServiceServer interface {
	mustEmbedUnimplementedOrgnServiceServer()
}

func RegisterOrgnServiceServer(s grpc.ServiceRegistrar, srv OrgnServiceServer) {
	// If the following call panics, it indicates UnimplementedOrgnServiceServer was
...
func _OrgnService_GetById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(OrgnServiceServer).GetById(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OrgnService_GetById_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrgnServiceServer).GetById(ctx, req.(*GetByIdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var OrgnService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "grpc/orgn_service.proto",
}
