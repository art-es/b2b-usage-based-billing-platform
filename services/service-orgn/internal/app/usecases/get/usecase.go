...
import (
	...
	"github.com/art-es/b2b-usage-based-billing-platform/services/service-orgn/internal/pkg/listcursor"
...
type Usecase struct {
	...
	listCursorEncoder *listcursor.Encoder[orgn.ListCursor]
	logger            log.Logger
}
...
func NewUsecase(
	...
	logger = logger.Set("pkg", "internal/app/usecases/get")

	return &Usecase{
		orgnRepository:    orgnRepository,
		listCursorEncoder: listcursor.NewEncoder[orgn.ListCursor]([]byte(cursorSecret)),
		logger:            logger,
	}
}
